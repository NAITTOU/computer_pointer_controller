...
class GazeEstimation:
    ...
    def load_model(self):
        ...
        self.input_name=self.network.inputs.keys()
        self.input_shape= {x:self.network.inputs[x].shape for x in self.input_name}
    ...
    def predict(self, gase_inputs):
        '''
        TODO: You will need to complete this method.
        This method is meant for running predictions on the input image.
        '''
        input_dict=gase_inputs
